...
import * as S from "../../pages/StoryFlow/styles";

import { LogoImage } from "../../pages/StoryFlow/styles";
...
export const Content1 = () => {
  ...
  const [bookTitle, setBookTitle] =
    useState<string>("동화 제목을 생성 중입니다...");
...
export const Content2 = () => {
  ...
  return (
    <S.Content2>
      {draftPages[latestDraft]
        ?.filter((page) => page.pageContent) // 페이지 내용이 있을 때만 렌더링
        .map((page) => (
          <S.Content2Element key={page.pageNum}>
            <S.Content2ElementInner>
              <p>
                {page.pageContent.replace(/[\[\]']/g, "").split(".")[0] + "."}
              </p>
            </S.Content2ElementInner>
          </S.Content2Element>
        ))}
